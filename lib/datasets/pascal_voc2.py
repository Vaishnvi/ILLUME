...
class pascal_voc(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        ...
        print("\n\n*****************",self._data_path)
        #self._cache_path = "/ssd_scratch/cvit/vkhindkar/data/"
    ...
    def gt_roidb(self):
        ...
        #cache_file =
        print("\n*********",self.cache_path) 
        cache_file = os.path.join("/ssd_scratch/cvit/vkhindkar/data/cache/", self.name + '_gt_roidb.pkl')
        print(cache_file)
